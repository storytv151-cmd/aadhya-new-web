...
const description =
  "Turn your Shopify store into a branded Android and iOS app with Go Cart — push notifications, automations, India-ready UPI checkout and app analytics. Plans from ₹1,499/month with a 14-day free trial.";
